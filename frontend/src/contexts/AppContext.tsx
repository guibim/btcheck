...
const translations = {
  "pt-BR": {
    ...
    paper_button: "Bitcoin Paper",
    paper_title: "Bitcoin: Um Sistema de Dinheiro Eletrônico Ponto a Ponto",
    paper_back: "Voltar",
    paper_download: "Baixar PDF",
    paper_fallback: "Seu navegador não suporta visualização de PDF. Clique abaixo para baixar.",
  ...
  "en": {
    ...
    paper_back: "Back",
    paper_download: "Download PDF",
    paper_fallback: "Your browser does not support PDF preview. Click below to download.",
